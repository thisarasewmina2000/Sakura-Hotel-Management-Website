        ...
        <div class="row">
            ...
            <?php 
                ...
                while($row = mysqli_fetch_assoc($res)){
                    echo<<<data
                        <div class="col-lg-4 col-md6 mb-5 px-4">
                            <div class="bg-white rounded shdow p-4 border-top border-4 border-dark pop">
                                <div class="d-flex align-items-center mb-2">
                                    <img src="$path$row[icon]" width="40px" height="40px" alt="">
